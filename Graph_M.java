...
import java.io.*;
	...
	public class Graph_M 
	{
		...
		{
			System.out.println("\t London Tube Map");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public static void Create Tube_Map(Graph_M g)
		{
			g.addVertex("Stratford");
			g.addVertex("West Ham");
			g.addVertex("Canning Town");
			g.addVertex("North Greenwich");
			g.addVertex("Canary Wharf");
			g.addVertex("Canada Water");
			g.addVertex("Bermondsey");
			g.addVertex("London Bridge");
			g.addVertex("Southwark");
			g.addVertex("Waterloo");
			g.addVertex("Westminster");
			g.addVertex("Green Park");
			g.addVertex("Bond Street");
			g.addVertex("Baker Street");
			g.addVertex("St. John's Wood");
			g.addVertex("Swiss Cottage");
			g.addVertex("Finchley Road");
			g.addVertex("West Hampstead");
			g.addVertex("Kilburn");
			g.addVertex("Willesden Green");
			
			g.addEdge("Stratford", "West Ham", 8);
			g.addEdge("West Ham", "Canning Town", 10);
			g.addEdge("Canning Town", "North Greenwich", 8);
			g.addEdge("North Greenwich", "Canary Wharf", 6);
			g.addEdge("Canary Wharf", "Canada Water", 9);
			g.addEdge("Canada Water", "Bermondsey", 7);
			g.addEdge("Bermondsey", "London Bridge", 6);
			g.addEdge("London Bridge", "Southwark", 15);
			g.addEdge("Southwark", "Waterloo", 6);
			g.addEdge("Waterloo", "Westminster", 7);
			g.addEdge("Westminster", "Green Park", 1);
			g.addEdge("Green Park", "Bond Street", 2);
			g.addEdge("Bond Street", "Baker Street", 5);
			g.addEdge("Baker Street", "St. John's Wood", 2);
			g.addEdge("St. John's Wood", "Swiss Cottage", 7);
			g.addEdge("Swiss Cottage", "Finchley Road", 8);
			g.addEdge("Finchley Road", "West Hampstead", 2);
			g.addEdge("West Hampstead", "Kilburn", 2);
			g.addEdge("Kilburn", "Willesden Green", 3);
		}
		...
		public static void main(String[] args) throws IOException
		{
			...
			System.out.println("\n\t\t\t****WELCOME TO THE Tube APP*****");
			// System.out.println("\t\t\t\t~~LIST OF ACTIONS~~\n\n");
			// System.out.println("1. LIST ALL THE STATIONS IN THE MAP");
			// System.out.println("2. SHOW THE Tube MAP");
